...
public class UserSaveDto {
    ...
    @NotNull
    private String          userId;                     // 회원ID (email)
    ...
    // builder 생성
    @Builder
    public UserSaveDto( String userId, String password, String userNm, String gender, String brdtDate, String telNo, String resideArea, Long atchFileSn, String mngrYn, String mngrConfmYn, String confmerId, String confmerIp, LocalDateTime confmDt, String snsKakaoCntnYn, LocalDateTime snsKakaoCntnDt, String snsGoogleCntnYn, LocalDateTime snsGoogleCntnDt, String snsNaverCntnYn, LocalDateTime snsNaverCntnDt, String snsFacebookCntnYn, LocalDateTime snsFacebookCntnDt, String snsAppleCntnYn, LocalDateTime snsAppleCntnDt, LocalDateTime lastLoginDt,  String registerIp, String updusrId, String updusrIp, String delYn,
