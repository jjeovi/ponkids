...
import com.meta.ponkids.domain.adm.system.menu.dto.MenuModDto;
import com.meta.ponkids.domain.adm.system.menu.entity.Menu;
import com.meta.ponkids.domain.adm.system.menu.entity.MenuHierarchy;
...
import com.meta.ponkids.domain.adm.system.menu.dto.MenuDto;
import com.meta.ponkids.domain.adm.system.menu.dto.MenuListDto;
import com.meta.ponkids.domain.adm.system.menu.dto.MenuRoleSaveDto;
import com.meta.ponkids.domain.adm.system.menu.dto.MenuSaveDto;
import com.meta.ponkids.domain.adm.system.menu.entity.AdminMenuHierarchy;
import com.meta.ponkids.domain.adm.system.menu.entity.MenuRole;
...
import com.meta.ponkids.domain.adm.system.menu.repository.MenuRoleRepository;
...
public class MenuService {
    ...
    public MenuSaveDto save( MenuSaveDto saveDto, HttpServletRequest request, String type ) throws IOException {
        ...
        if ( type.equals( TYPE_ADMIN ) ) {
            newMenu = menuRepository.save( saveDto.toEntity() ); // ** save -> save된 정보 newXxx 로 저장
            
        } else if ( type.equals( TYPE_USER ) ) {
            newMenu = menuRepository.saveAndFlush( saveDto.toEntity() ); // ** save -> save된 정보 newXxx 로 저장
        }
...
//                    System.out.println("변경이 감지되지 않았습니다. 혹은 최초 캐시 저장시입니다.");
    ...
    @Transactional
    public void update( MenuModDto modDto, HttpServletRequest request, String type ) throws IOException {
    ...
    @Transactional
    @CacheEvict( value = {
            "lastUpdtDtUserMenuCache",
            "lastUpdtDtAdminMenuCache" })
    public void delete( MenuModDto modDto ) {
...
//                System.out.println( "updtDtMenuNoCache의 최종 수정시간 = " + updtDtMenuNoCache.getUpdtDt() );
    ...
    @Transactional
    // 메뉴 등록, 수정, 삭제 시 사용자 메뉴 리스트를 json화 하여 파일로 생성(리프레시)
    public void menuSaveToJsonFile() throws IOException {
