...
public class BannerSaveDto {
    ...
    @Builder
    public BannerSaveDto( Long bannerSn, String bannerClCd, String bannerClDetailCd, Long bannerExpsrSeq,
                          String bannerNm, String bannerDc, Long atchFileSn, String url, String classMapngYn, Long classSn,
                          String useYn, String bannerPdSetYn, String bannerBeginDt, String bannerEndDt, String registerId,
