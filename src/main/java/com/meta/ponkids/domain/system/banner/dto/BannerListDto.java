...
public class BannerListDto {
    ...
    private String  bannerClNm;             // 배너 분류 명
    
    private String  bannerClDetailCd;       // 배너 분류 상세 코드
    
    private String  bannerClDetailNm;       // 배너 분류 상세 명
    ...
    private String  bannerExpsrPeriod;      // 배너 표시 기간
    ...
    public BannerListDto( Long bannerSn, String bannerClCd, String bannerClNm, String bannerClDetailCd, String bannerClDetailNm, Long bannerExpsrSeq,
        ...
        this.bannerClNm = bannerClNm;
        this.bannerClDetailCd = bannerClDetailCd;
        this.bannerClDetailNm = bannerClDetailNm;
