...
//	public void update ( LctreModDto modDto, LctreRoleModDto lctreRoleModDto, HttpServletRequest request ) throws IOException {
        ...
        if ( StringUtils.hasText( modDto.getClassDayCd() ) )
            targetDto.setClassDayCd( modDto.getClassDayCd() );    // 수업 요일
        targetDto.setLctreSeq( modDto.getLctreSeq() );                                                          // 수업 순번
        if ( StringUtils.hasText( modDto.getLctreSj() ) )
            targetDto.setLctreSj( modDto.getLctreSj() );            // 수업 제목
        if ( StringUtils.hasText( modDto.getLctreDt() ) )
            targetDto.setLctreDt( modDto.getLctreDt() );            // 수업 일시
        ...
        if ( StringUtils.hasText( modDto.getRcritNmprSetYn() ) )
            targetDto.setRcritNmprSetYn( modDto.getRcritNmprSetYn() );            // 모집인원 설정여부
        targetDto.setRcritNmprCo( modDto.getRcritNmprCo() );                                                    // 모집인원 수
        if ( StringUtils.hasText( modDto.getPreparRcritNmprSetYn() ) )
            targetDto.setPreparRcritNmprSetYn( modDto.getPreparRcritNmprSetYn() );            // 모집인원 설정여부
