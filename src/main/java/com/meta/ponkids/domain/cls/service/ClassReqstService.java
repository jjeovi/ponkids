...
public class ClassReqstService {
    private final ClassReqstRepository classReqstRepository;    // repository setting
    
    @Transactional
    public ClassReqstSaveDto save( ClassReqstSaveDto saveDto, HttpServletRequest request ) throws IOException {
        ...
        ClassReqst newClassReqst = classReqstRepository.save( saveDto.toEntity() );            // ** save -> save된 정보 newXxx 로 저장
        saveDto.setClassReqstSn( newClassReqst.getClassReqstSn() );
