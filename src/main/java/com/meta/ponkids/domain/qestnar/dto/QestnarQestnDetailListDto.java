...
@Data
@NoArgsConstructor
public class QestnarQestnDetailListDto {
	...
	@QueryProjection
	public QestnarQestnDetailListDto(Long qestnarQestnDetailSn, Long qestnarQestnSn, Long qestnarQestnDetailSeq,
			String qestnarQestnDetailCn, String registerId, String regDt) {
